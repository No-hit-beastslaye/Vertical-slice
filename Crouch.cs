...
public class Crouch : MonoBehaviour
{
    ...
    public Vector3 CapsuleCrouchHeight;              //Capsule.center update voor de crouch animatie
    ...
    void Update()
    {
        ...
        if (C == true && PlayerCollider.height >= CrouchingHeight && Crouching == false)
        {
            ...
            //Changes the capsule center height to the crouch position height, so it prevents clipping.
        ...
        else if (C == false && PlayerCollider.height <= StandingHeight && Standing == false)
        {
            ...
            //Changes the capsule center height back to 0
